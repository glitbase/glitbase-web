    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          {/* Address detail - only visible if service.isDelivery === true */}
          {hasDeliveryService && (
            <View style={styles.detailItem}>
              <View style={styles.iconCircle}>
              ...
              <View style={styles.detailContent}>
                <Text weight="medium" style={styles.detailLabel}>
                  {formData.serviceType === 'home' ? 'Address' : 'Addresses'}
                </Text>
                <Text weight="medium" style={styles.detailValue}>
                  {formData.serviceType === 'home'
                    ? (formData.contactAddress ? JSON.parse(formData.contactAddress).address : 'Not set')
                    : (formData.pickupAddress && formData.dropoffAddress ? 'Pickup & Drop-off set' : 'Not set')}
                </Text>
              </View>
              <Pressable onPress={() => onGoToStep(hasDeliveryService ? 'address' : 'dateTime')} style={styles.editButton}>
                <Image
                  source={{
                    uri: "https://cdn-icons-png.flaticon.com/128/16972/16972938.png",
                  }}
